...
public class BabyTravels
{
   ...
   Customer customers[] = new Customer[customer.size()];
    ...
    public void Serialise()
    {
        try
        {
            FileOutputStream fo = new FileOutputStream("D:\\ghost videos\\suhail.txt");
        ...
        public void deSerialise() {
                try {
                        FileInputStream fi = new FileInputStream("D:\\ghost videos\\suhail.txt");

                        ObjectInputStream oo = new ObjectInputStream(fi);
                        ArrayList<BabyTravels> b=new ArrayList<>();
                        for(int i=0;i<customer.size();i++)
                        {
                                customers[i]=(Customer) oo.readObject();
                        }
                }
                catch(Exception e)
                {
                ...
                {
                       List al = Arrays.asList(customers);
