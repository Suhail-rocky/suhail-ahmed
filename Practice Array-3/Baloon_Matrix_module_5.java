...
public class Baloon_Matrix_module_5{
	static int count =0;
	 static int count1=0;
	 static int c=0;
	 static int g=0;
	public static void main(String[] args)
   {
       ...
       do {
    	...
    	//System.out.println(arr[arr.length-1][2]);
       	//System.out.println(arr[arr.length-1][1].equals(arr[arr.length-1][0])&& arr[arr.length-1][0].equals(arr[arr.length-1][2]) );
       		if(arr[arr.length-1][1].equals(arr[arr.length-1][0])&& arr[arr.length-1][0].equals(arr[arr.length-1][2])  )
       		{	
