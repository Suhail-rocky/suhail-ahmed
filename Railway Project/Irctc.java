...
class CancelTickets extends passengerDetails{
	void CancelTicket(){
		...
		if(Seatno[TicketNo-1]!=0){
				System.out.println("Ticket No\tName\tAge\tGender\tBerth\t");
				System.out.println("\t"+Pnr[TicketNo-1]+"\t"+Seatno[TicketNo-1]+"\t"+Name[TicketNo-1]+"\t"+Age[TicketNo-1]+"\t"+Gender[TicketNo-1]+"\t"+Berth[TicketNo-1]+"\t");
			}
			System.out.println("1>Cancel");
			int CancelValue = scan.nextInt();
			if(CancelValue == 1){
				Pnr[TicketNo-1]=Pnr[TicketNo];
				Seatno[TicketNo-1]=Seatno[TicketNo];
				...
				System.out.println("Ticket No\tName\tAge\tGender\tBerth\t");
				System.out.println("\t"+Seatno[TicketNo]+"\t"+Name[TicketNo]+"\t"+Age[TicketNo]+"\t"+Gender[TicketNo]+"\t"+Berth[TicketNo]+"\t");
				if(TicketNo == 1){
					int i1=5;
					Seatno[TicketNo]=Seatno[TicketNo+i1];
					...
					System.out.println("Ticket No\tName\tAge\tGender\tBerth\t");
					System.out.println("\t"+Seatno[TicketNo+i1]+"\t"+Name[TicketNo+i1]+"\t"+Age[TicketNo+i1]+"\t"+Gender[TicketNo+i1]+"\t"+Berth[TicketNo+i1]+"\t");
				}
				if(TicketNo == 2){
					int i1=6;
					Seatno[TicketNo]=Seatno[TicketNo+i1];
